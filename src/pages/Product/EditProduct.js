...
const EditProduct = ({ onHide }) => {
  ...
  const notifyUpdate = () => {
    ...
    toast.success("Ngài đã cập nhật đồ uống thành công", {
      position: "top-right",
      autoClose: 3000,
    ...
    <>
      ...
      <Modal show={show} onHide={onHide}>
        <Modal.Header closeButton onClick={handleClose}>
          <Modal.Title className="btn-title">Sửa đồ uống</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formDetail">
              ...
              <Form.Control
                ...
                value={"Thơm ngon mát lạnh như nụ cười của em"}
